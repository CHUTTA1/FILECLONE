...
def xoshnaw():
  ...
  try:
    httpCaht = requests.get("https://github.com/CHUTTA1/FILECLONE/blob/main/Active.txt").text
    if id in httpCaht:
...
try:
	prox= requests.get('https://github.com/CHUTTA1/FILECLONE/blob/main/Active.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/CHUTTA1/FILECLONE/blob/main/Active.txt').text
